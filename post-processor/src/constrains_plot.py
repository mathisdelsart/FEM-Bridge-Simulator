...
if __name__ == "__main__":
    ...
    nameMesh = "../../reports/data/mesh.txt"
    mesh = Mesh(nameMesh)
    nameConstrainsFile = "../../reports/data/maxConstrainBridge.txt"
    maxConstrainSol = np.loadtxt(nameConstrainsFile)

    nameSolution = "../../reports/data/UV.txt"
    ...
    # plt.savefig("../../reports/data/maxConstrainBridge.pdf", bbox_inches='tight')
    plt.show()
