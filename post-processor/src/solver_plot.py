...
mesh_size, nodes, full_solver, band_solver_no_order, band_solver_x_order, band_solver_y_order, band_solver_rcmk_order, no_order_ratio, x_order_ratio, y_order_ratio, rcmk_order_ratio = np.loadtxt('../../reports/data/csv/solver_type.csv', delimiter=',', unpack=True, skiprows=1)
...
plt.tight_layout()
# plt.savefig('../../reports/data/solver_plot.pdf', bbox_inches='tight')
plt.show()