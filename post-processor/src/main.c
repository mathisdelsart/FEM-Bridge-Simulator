...
#include "../../processor/src/fem.h"
#include "../../processor/src/implementation.c"

#include "../../pre-processor/src/glfem.h"
...
int main(int argc, char *argv[])
{
    ...
    char *problemPath;
    char *resultPath;
    if      (example_UForm)      { meshPath = "../../reports/data/mesh_example.txt";     problemPath = "../../reports/data/problem_example.txt";     resultPath = "../../reports/data/UV_example.txt"; }
    else if (example_beam)       { meshPath = "../../reports/data/mesh_beam.txt";        problemPath = "../../reports/data/problem_beam.txt";        resultPath = "../../reports/data/UV_beam.txt"; }
    else if (example_simplified) { meshPath = "../../reports/data/mesh_simplified.txt";  problemPath = "../../reports/data/problem_simplified.txt";  resultPath = "../../reports/data/UV_simplified.txt"; }
    else                         { meshPath = "../../reports/data/mesh.txt";             problemPath = "../../reports/data/problem.txt";             resultPath = "../../reports/data/UV.txt"; }
    ...
    if (example_UForm == FALSE && example_beam == FALSE && example_simplified == FALSE)
    {
        ...
        FILE *file = fopen("../../reports/data/maxConstrainBridge.txt", "w");
