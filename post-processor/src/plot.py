...
def generate_frame(i):
    ...
    nameSolution = ""
    if animation_position: nameSolution = "../../reports/data/animations/UV_animation_position_{}.txt".format(i + 1)
    elif exampleUForm_Use: nameSolution = "../../reports/data/animations/UV_example_{}.txt".format(i + 1)
    elif beamUse:          nameSolution = "../../reports/data/animations/UV_beam_{}.txt".format(i + 1)
    elif simplifiedUse:    nameSolution = "../../reports/data/animations/UV_simplified_{}.txt".format(i + 1)
    else :                 nameSolution = "../../reports/data/animations/UV_{}.txt".format(i + 1)
...
if __name__ == "__main__":
    ...
    nameMesh = ""
    if exampleUForm_Use: nameMesh = "../../reports/data/mesh_example.txt"
    elif beamUse:        nameMesh = "../../reports/data/mesh_beam.txt"
    elif simplifiedUse:  nameMesh = "../../reports/data/mesh_simplified.txt"
    else :               nameMesh = "../../reports/data/mesh.txt"

    mesh = Mesh(nameMesh)

    if not animation:
        nameSolution = ""
        if exampleUForm_Use: nameSolution = "../../reports/data/UV_example.txt"
        elif beamUse:        nameSolution = "../../reports/data/UV_beam.txt"
        elif simplifiedUse:  nameSolution = "../../reports/data/UV_simplified.txt"
        else :               nameSolution = "../../reports/data/UV.txt"
