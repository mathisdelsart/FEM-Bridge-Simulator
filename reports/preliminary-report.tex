...
\begin{titlepage}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{assets/UCLouvain_Logo.pdf}
    \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{figs/preliminary-report/GeometryProblem.png}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.6\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figs/preliminary-report/geometry.png}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figs/preliminary-report/mesh_geometry.png}
