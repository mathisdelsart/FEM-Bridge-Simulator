...
int main(int argc, char *argv[])
{
    ...
    if (exampleUForm_Example == TRUE)
    {
        ...
        geoMeshWrite("../../reports/data/mesh_example.txt", discretType);
    }
    else if (exampleBeam_Example == TRUE)
    {
        ...
        geoMeshWrite("../../reports/data/mesh_beam.txt", discretType);
    }
    else if (bridgeSimplified == TRUE)
    {
        ...
        geoMeshWrite("../../reports/data/mesh_simplified.txt", discretType);
    }
    else
    {
        geoMeshGenerate(discretType, bridgeSimplified);
        geoMeshImport(discretType);
        setDomainsName(bridgeSimplified);
        geoMeshWrite("../../reports/data/mesh.txt", discretType);
    }
    ...
    if (exampleUForm_Example == TRUE)
    {
        ...
        femElasticityWrite(theProblem, "../../reports/data/problem_example.txt");
    }
    else if (exampleBeam_Example)
    {
        ...
        femElasticityWrite(theProblem, "../../reports/data/problem_beam.txt");
    }
    else if (bridgeSimplified == TRUE)
    {
        E = 200.e9;
        ...
        femElasticityWrite(theProblem, "../../reports/data/problem_simplified.txt");
    }
    else
    {
        E = 200.e9;
        ...
        createBoundaryConditions(theProblem, bridgeSimplified);
        femElasticityPrint(theProblem);
        femElasticityWrite(theProblem, "../../reports/data/problem.txt");
    }
